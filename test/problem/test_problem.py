...
def test_round_trip():
    ...
    with open("expected_output/petab_select_problem.yaml") as f:
        problem_yaml0 = f.read()
    with open("expected_output/model_space.tsv") as f:
        model_space_tsv0 = f.read()

    with open("output/petab_select_problem.yaml") as f:
        problem_yaml1 = f.read()
    with open("output/model_space.tsv") as f:
